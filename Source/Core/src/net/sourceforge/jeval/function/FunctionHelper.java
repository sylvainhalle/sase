...
public class FunctionHelper {
	 ...
	 *                values.
	 */
	public static ArrayList<Double> getDoubles(final String arguments,
	 ...
	 *                values.
	 */
	public static ArrayList<String> getStrings(final String arguments,
			final char delimiter) throws FunctionException {
	...
	public static ArrayList<Comparable> getOneStringAndOneInteger(final String arguments,
			final char delimiter) throws FunctionException {

		ArrayList<Comparable> returnValues = new ArrayList<Comparable>();
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static ArrayList<Comparable> getTwoStringsAndOneInteger(final String arguments,
			final char delimiter) throws FunctionException {

		final ArrayList<Comparable> returnValues = new ArrayList<Comparable>();
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static ArrayList<Comparable> getOneStringAndTwoIntegers(final String arguments,
			final char delimiter) throws FunctionException {
